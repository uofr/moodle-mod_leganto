...
$string['modulename'] = 'Reading List (inline)';
$string['modulename_help'] = '<p>The Reading List (inline) module enables an instructor to include a selection of citations from associated Leganto reading lists directly within the course.</p><p>The reading list can be displayed either in a separate, linked page, or embedded in the course page itself (hidden initially, with a link to toggle visibility).</p>';
$string['modulename_link'] = 'mod/leganto/view';
$string['modulenameplural'] = 'Reading lists (inline)';
...
$string['pluginadministration'] = 'Reading List (inline) administration';
$string['pluginname'] = 'Leganto reading list';
$string['privacy:metadata'] = 'The Reading List (inline) module does not store any personal data';
