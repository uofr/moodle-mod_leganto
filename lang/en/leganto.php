...
$string['cachedef_listdata'] = 'Cached Leganto resource list / citation data fetched from Alma API';
...
$string['leganto'] = 'Resource list: {$a}';
$string['leganto:addinstance'] = 'Add a new resource list';
$string['leganto:view'] = 'View resource list content';
$string['legantoname'] = 'Resource list name';
$string['modulename'] = 'Leganto resource list';
$string['modulename_help'] = '<p>The Leganto resource list module enables a teacher to include a selection of resources from associated Leganto resource lists directly within the content of their course.</p><p>The resource list can be displayed either in a separate, linked page, or embedded in the course page itself (hidden initially, with a link to toggle visibility).</p>';
$string['modulename_link'] = 'mod/leganto/view';
$string['modulenameplural'] = 'Leganto resource lists';
$string['nolegantos'] = 'Sorry, there are no resource lists associated with this {$a}.';
$string['page-mod-leganto-view'] = 'Resource list module main page';
$string['page-mod-leganto-x'] = 'Any resource list module page';
$string['pluginadministration'] = 'Leganto resource list administration';
$string['pluginname'] = 'Leganto resource list';
